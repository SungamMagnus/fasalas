...
/**
 * Output limiter — the house one, from Afbökun and Colacut, unchanged.
 *
 * Stereo-linked peak follower with an instant-ish attack and a slow release,
 * then a hard clamp for the little a 2 ms attack lets through. No lookahead:
 * it never adds latency, and what slips past is brief and small enough for
 * the clamp. Off unless asked for.
 */
class Limiter
{
public:
